...
- **`READONLY_MODE=true`** hides every vault-writing tool — useful for sharing a vault with an assistant that should browse and search but never edit, or for a first deployment before enabling writes.
