...
- **Text and data files** — SVG, JSON, CSV, YAML, logs, and [Bases](https://help.obsidian.md/bases) files return exactly as written; their content is full-text searchable too. Big data files and logs can be read a line range at a time, with each page reporting where you are and how much file remains
