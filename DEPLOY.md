...
| `PROTECTED_PATHS`                     | Optional. Comma-separated folders protected from deletion and moves (default: `MEMORY_DIR` + daily notes folder from `DAILY_NOTES_FOLDER`, `.obsidian/daily-notes.json`, or `Daily Notes`). Overrides the default entirely when set.                                                                                                                                                                                                                                                                |
