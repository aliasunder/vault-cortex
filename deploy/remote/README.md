...
| `OBSIDIAN_AUTH_TOKEN` | Output from step 3. Or leave empty to sign in through the `/setup` page after starting. To re-sign-in, set a new token and re-create the container — it always overrides the saved login on the volume   |
