...
# When the same note changed in two places: merge | conflict (default: merge).
# 'merge' resolves it the way Sync does between your own devices (earlier versions
# stay in Sync's version history); 'conflict' keeps the other version as a separate
# conflict file next to the note.
