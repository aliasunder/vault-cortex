...
# Daily notes folder and filename format overrides (default: read from the
# vault's .obsidian/daily-notes.json, falling back to "Daily Notes" and
# YYYY-MM-DD). Format takes the same tokens as Obsidian's date format setting.
...
# below; falls back to "Daily Notes" and YYYY-MM-DD). Format takes the same
# tokens as Obsidian's date format setting.
# DAILY_NOTES_FOLDER=Journal
# DAILY_NOTES_FORMAT=YYYY-MM-DD
