...
- **Chunk prefixes:** note title plus a `Section:` line naming the heading's ancestor path. A heading with no body emits no chunk — its words appear in descendant chunks' Section lines
