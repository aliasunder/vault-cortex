...
| Position-aware blending over full reranker | Full cross-encoder reranking (pure reranker sort) scored 8/9 — it over-prioritized topical relevance on task-oriented queries, demoting structurally correct results (TASKS.md) in favor of chat transcripts. Position-aware blending protects strong RRF hits at top ranks (75% retrieval weight for ranks 1–3) while letting the reranker rescue demoted results at lower ranks (60% reranker weight for ranks 11+). Validated at 9/9, 0 regressions, ~200ms added latency. Opt-out via `RERANK_MODE=none`.                                                                                                                                                                                                                                                                                                                                                                             |
