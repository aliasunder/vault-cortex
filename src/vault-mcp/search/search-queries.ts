...
const TASK_ORDER_BY: Record<TaskSortKey, (explicitDirection: "ASC" | "DESC" | undefined) => string> = {
...
export const vaultStats = (context: SearchQueryContext, _params: Record<string, never>, logger: Logger): VaultStats => {
