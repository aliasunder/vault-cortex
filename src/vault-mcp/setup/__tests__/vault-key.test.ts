...
import { deriveVaultKeyHash, isSupportedEncryptionVersion } from "../vault-key.js"
...
const KEY_HASH_V3 = "60aa76a8ebdc3bd3fff0670081c08bc8056407f765a1c7b0918cc7077639a398" // gitleaks:allow
// PASSWORD + SALT at encryption version 0:
const KEY_HASH_V0 = "70e71fbaf4e6016807c7d24edd32dce10c0c1f7491ccea42a848f7d078990490" // gitleaks:allow
// "pässwörd" + "salt" at encryption version 3:
const NON_ASCII_KEY_HASH_V3 = "8d8534f8d78a42c892f4edb0b0c9adbb3554954bfab6c09d708c93aa8e633f5a" // gitleaks:allow
...
describe("isSupportedEncryptionVersion", () => {
  it("accepts the versions the pinned client derives keys for", () => {
    expect([0, 2, 3].map(isSupportedEncryptionVersion)).toEqual([true, true, true])
  })
