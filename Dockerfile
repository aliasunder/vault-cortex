...
LABEL io.modelcontextprotocol.server.name="io.github.aliasunder/vault-cortex" \
      ...
      org.opencontainers.image.description="Standalone MCP server for Obsidian vaults — hybrid search, memory, tasks, files. One-click deploy" \
...
LABEL org.opencontainers.image.description="Standalone MCP server for Obsidian vaults with bundled Obsidian Sync — hybrid search, memory, tasks, files. One-click deploy"
