...
LABEL io.modelcontextprotocol.server.name="io.github.aliasunder/vault-cortex" \
      ...
      org.opencontainers.image.description="Standalone MCP server for Obsidian vaults — hybrid search, memory, tasks, files, OAuth 2.1" \
...
LABEL org.opencontainers.image.description="Standalone MCP server for Obsidian vaults with bundled Obsidian Sync — hybrid search, memory, tasks, files, OAuth 2.1"
